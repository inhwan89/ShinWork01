...
<style>
#MemberJoin_result table{margin : 0 auto;}
#MemberJoin_result h2{border-bottom: 3px solid #036; padding-bottom: 5px; text-align: center; margin-left: 600px; margin-right: 600px;}
#MemberJoin_result tr, td{border: 1px solid gray;}
#MemberJoin_result .w3-table{width: 600px;}
#MemberJoin_result td{text-align: center; }
#MemberJoin_result .td_1{margin-right: 5px; background-color: #eaedf2;}
</style>
</head>
<body>
<br/><br/><br/><br/><br/><br/>
<div id="MemberJoin_result">
<div class="w3-container">
<form name="frm_MemberJoin_result" method="post">
<input type="hidden" name="selection" value="${vo.selection }">
  <h2 class="w3-text-blue">${vo.mid }님의 회원가입을 축하합니다!</h2><br/>
<c:choose>			
  ...
  <div id="btnLogin_div" class="w3-center">
...
<script>
var frm = document.frm_MemberJoin_result;
