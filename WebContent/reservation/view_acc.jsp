...
<style>
#view_acc{margin: auto; width:55%; padding: 45px; background: linear-gradient(180deg, #041c42 40%, #ccd4e0 100%);  border-radius: 15px 15px 0 0;}
#view_acc h2{border-bottom: 3px solid #036; padding-bottom: 5px; margin-left:60px; margin-right:60px; }
#view_acc .container-fluid{margin: 0; width: 100%; padding: 15px; margin-bottom: 12px; background-color:#ffffff; border-radius: 15px;  box-shadow: 0px 0px 25px -5px rgba(0, 0, 0, 0.8);}
#view_acc #view_div{width: 100%; padding-bottom: 25px; padding-left: 100px;}
#view_acc .input-group-addon{background-color: #000000; opacity: 0.6; color: #ffffff; font-weight: bold;}
</style>
</head>
<body>
<br/><br/><br/><br/><br/><br/>
<div id="view_acc" class="w3-center">
		 ...
		 <div class="row content" >
				...
				<br/>
					<div class="input-group">
						...
						<input type="text" class="form-control text-center" name="irum" value = '${avo.aname}' style="width: 550px;background: #ffffff;" readonly>
					</div>
					<div class="input-group">
						<span class="input-group-addon" style="width: 200px;">연락처</span>
						<input type="text" class="form-control text-center" name="irum" value = '${avo.phone}' style="width: 550px;background: #ffffff;" readonly>
					</div>
					<div class="input-group">
					...
					<div class="input-group">
						<span class="input-group-addon" style="width: 200px;">CheckIn ~ CheckOut</span>
						<input type="text" class="form-control text-center" name="rdate" value = "${dvo.rdate }~${dvo.endDate }" style="width: 550px;background: #ffffff;" readonly>
					</div>
					<div class="input-group">
						<span class="input-group-addon" style="width: 200px;">Room</span>
						<input type="text" class="form-control text-center" name="menu" value = "${dvo.room }" style="width: 550px;background: #ffffff;" readonly>
					</div>
					<div class="input-group">
	...
	<form name="frm_view_acc" method="post">
		<input type="hidden" name="menu" value ="${dvo.room }">
		<input type="hidden" name="rdate" value="${dvo.rdate }">
		<input type="hidden" name="price" value="${vo.price }">
		<input type="hidden" name="mem_se" value="${mem_vo.serial }">
		<input type="hidden" name="acc_se" value="${avo.serial }">
